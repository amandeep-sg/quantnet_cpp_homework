...
int main()
{
    ...
    // simulate by changing spot price from 60 to 65 over 5 intervals
    for (const double i : Simulator.Simulate(name[0]))
    {
        cout << setw(10) << i << " ";
    }
    cout << endl<<endl;

    // simulate by changing strike and spot price from 60 to 65 over 5 intervals
    for (const vector<double> row : Simulator.Simulate(name))
    {
