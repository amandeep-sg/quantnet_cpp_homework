// Array.cpp
// program to define the Array class i.e. constructors, destructor, data members, member functions
//
...
namespace ADSINGH
{
    namespace CONTAINER
    {
        ...
        template <typename T>
        unsigned int Array<T>::default_size = 5; // initialise static variable default_size
