// c program to count no of characters, words and newlines in the user input using do-while loop
...
int main()
{
    ...
    {
        input = getchar();
        if (input == EOF || input == 26 || input == 4) // break the while loop if ctrl+D pressed
        {
            break;
        }
