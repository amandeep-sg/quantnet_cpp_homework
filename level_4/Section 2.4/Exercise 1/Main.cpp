...
int main()
{
    ...
    cout << "Point_a: " << point_a.ToString() << endl;

    Point point_b(3, 3); // create a point with x-coordinate = 3 and y-coordinate = 3
    cout << "Point_b: " << point_b.ToString() << endl;

    point_b = point_b + (-point_a); // add coordinates of point_b and (-point_a)
    cout << "Modified Point_b: " << point_b.ToString() << endl
         << endl;

    // test * and *= operators of Point class
    cout << "scale point_a by factor of 4 (without modifying point_a): " << (4 * point_a).ToString() << endl; // scale the value of point_a without modifying it
    cout << "Point_a: " << point_a.ToString() << endl;
    cout << "scale point_a by factor of 5 (by modifying point_a): " << (point_a *= 5).ToString() << endl
    ...
    cout << "original line_a: " << line_a.ToString() << endl;
    cout << "original line_b: " << line_b.ToString() << endl;

    line_b = line_a; // assign start and end point of line a to line b
    cout << "modified line_b: " << line_b.ToString() << endl
         << endl;
    ...
    cout << "original circle_a: " << circle_a.ToString() << endl;
    cout << "original circle_b: " << circle_b.ToString() << endl;

    circle_b = circle_a; // assign center point and raidus of circle a to circle b
    cout << "modified circle_b: " << circle_b.ToString() << endl;
