...
namespace ADSINGH
{
    namespace CAD
    {
        ...
        public:
            ...
            Circle(const Point &center_point, double raidus); // constructor with center point and raidus
            ...
            const void Draw();         // draw circle in the cartesian plane
            ...
            friend ostream &operator<<(ostream &os, const Circle &source);
        };
    }
}
