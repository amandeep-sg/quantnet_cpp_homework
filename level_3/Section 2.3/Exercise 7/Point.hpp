...
public:
    ...
    void X(double x) { point_x = x; }; // update the value of x coordinate of a point
    void Y(double y) { point_y = y; }; // update the value of y coordinate of a point
...
inline double Point::X() const { return point_x; } // return x coordinate of the point
inline double Point::Y() const { return point_y; } // return y coordinte of the point
