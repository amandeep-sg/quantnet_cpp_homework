...
double Point::X() { return point_x; } // return x coordinate of the point
double Point::Y() { return point_y; } // return y coordinte of the point
...
double Point::Distance() // return distance of the point from origin
{
